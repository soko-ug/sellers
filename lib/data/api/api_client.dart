...
import 'package:sokosellers/data/model/response/error_response.dart';
import 'package:sokosellers/data/repository/login_response.dart';
import 'package:sokosellers/helper/main_helper.dart';
...
class ApiClient extends GetxService {
  ...
  //  Map<String, String>? get commonHeader = _commonHeader;
...
static Future<http.Response> sokoGet(
  ...
  static Future<http.Response> postSoko(
      {required String url,
