...
List<CartSellerItem> cartSellerItemsList_1 = [
  CartSellerItem(
    id: "1",
    cart_item_id: "101",
    name: "HP Spectre x360 13-AE517TU 8th Gen int ?el Core i7 8550U",
    price: 548.00,
    quantity:2,
  ...
  CartSellerItem(
    ...
    cart_item_id: "103",
    name:
        "Apple Macbook Air (2017) Dual Core int ?el Core i5 (1.8-2.9GHz, 8GB 1600MHz LPDDR3, 256GB PCIe Onboard SSD)",
    price: 1200.00,
    quantity:4,
...
List<CartSeller> cartSellerList = [
  CartSeller(
      id: "1",
      name: "A-Z Importers int ?ernational",
