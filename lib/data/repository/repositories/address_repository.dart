import 'package:sokosellers/sharedValues.dart';
import 'package:sokosellers/util/app_config.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

import 'package:sokosellers/data/data_model/address_response.dart';
import 'package:sokosellers/data/data_model/address_add_response.dart';
import 'package:sokosellers/data/data_model/address_update_response.dart';
import 'package:sokosellers/data/data_model/address_update_location_response.dart';
import 'package:sokosellers/data/data_model/address_delete_response.dart';
import 'package:sokosellers/data/data_model/address_make_default_response.dart';
import 'package:sokosellers/data/data_model/address_update_in_cart_response.dart';
import 'package:sokosellers/data/data_model/city_response.dart';
import 'package:sokosellers/data/data_model/state_response.dart';
import 'package:sokosellers/data/data_model/country_response.dart';
import 'package:sokosellers/data/data_model/shipping_cost_response.dart';
...
class AddressRepository {
  ...
  Future<AddressUpdateInCartResponse> getShippingTypeUpdateInCartResponse(
    ...
    print(url.toString());
    print(post_body.toString());
    print(AppConfig.bToken.toString());
    final response = await http.post(url,
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer ${AppConfig.bToken}",
