...
import 'package:sokosellers/data/data_model/login_response.dart';
import 'package:sokosellers/data/data_model/logout_response.dart';
import 'package:sokosellers/data/data_model/signup_response.dart';
import 'package:sokosellers/data/data_model/resend_code_response.dart';
import 'package:sokosellers/data/data_model/confirm_code_response.dart';
import 'package:sokosellers/data/data_model/password_forget_response.dart';
import 'package:sokosellers/data/data_model/password_confirm_response.dart';
import 'package:sokosellers/data/data_model/user_by_token.dart';
...
class AuthRepository {
  ...
  Future<UserByTokenResponse> getUserByTokenResponse() async {
    var post_body = jsonEncode({"access_token": "${AppConfig.bToken}"});
