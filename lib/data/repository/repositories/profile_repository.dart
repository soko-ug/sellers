...
import 'package:sokosellers/data/data_model/profile_image_update_response.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

import 'package:sokosellers/data/data_model/profile_counters_response.dart';
import 'package:sokosellers/data/data_model/profile_update_response.dart';
import 'package:sokosellers/data/data_model/device_token_update_response.dart';
import 'package:sokosellers/data/data_model/phone_email_availability_response.dart';
...
class ProfileRepository {
  ...
  Future<ProfileUpdateResponse> getProfileUpdateResponse(
    ...
    final response = await http.post(url,
        headers: {"Content-Type": "application/json", "Authorization": "Bearer ${AppConfig.bToken}","App-Language": AppConfig.mobile_app_code,},body: post_body );
  ...
  Future<PhoneEmailAvailabilityResponse> getPhoneEmailAvailabilityResponse() async {
    ...
    final response = await http.post(url,
        headers: {"Authorization": "Bearer ${AppConfig.bToken}","App-Language": AppConfig.mobile_app_code,});
