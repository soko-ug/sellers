...
import 'dart:convert';
import 'package:sokosellers/data/data_model/payment_type_response.dart';
import 'package:sokosellers/data/data_model/order_create_response.dart';
import 'package:sokosellers/data/data_model/paypal_url_response.dart';
import 'package:sokosellers/data/data_model/flutterwave_url_response.dart';
import 'package:sokosellers/data/data_model/razorpay_payment_success_response.dart';
import 'package:sokosellers/data/data_model/paystack_payment_success_response.dart';
import 'package:sokosellers/data/data_model/iyzico_payment_success_response.dart';
import 'package:sokosellers/data/data_model/bkash_begin_response.dart';
import 'package:sokosellers/data/data_model/bkash_payment_process_response.dart';
import 'package:sokosellers/data/data_model/nagad_begin_response.dart';
import 'package:sokosellers/data/data_model/nagad_payment_process_response.dart';

import 'package:sokosellers/data/data_model/sslcommerz_begin_response.dart';
...
class PaymentRepository {
  ...
  Future<PaypalUrlResponse> getPaypalUrlResponse(@required String payment_type,
    ...
    Uri url = Uri.parse(
      "${AppConfig.BASE_URL}/paypal/payment/url?payment_type=${payment_type}&combined_order_id=${combined_order_id}&amount=${amount}&user_id=${AppConfig.user_id}",
    );
    final response = await http.get(url, headers: {
      "App-Language": AppConfig.mobile_app_code,
    });
  ...
  Future<FlutterwaveUrlResponse> getFlutterwaveUrlResponse(
    ...
    Uri url = Uri.parse(
        "${AppConfig.BASE_URL}/flutterwave/payment/url?payment_type=${payment_type}&combined_order_id=${combined_order_id}&amount=${amount}&user_id=${AppConfig.user_id}");
  ...
  Future<OrderCreateResponse> getOrderCreateResponseFromCod(
      @required payment_method) async {
    var post_body = jsonEncode(
        {"user_id": "${AppConfig.user_id}", "payment_type": "${payment_method}"});
  ...
  Future<BkashBeginResponse> getBkashBeginResponse(
      ...
      @required double amount) async {
    Uri url = Uri.parse(
        "${AppConfig.BASE_URL}/bkash/begin?payment_type=${payment_type}&combined_order_id=${combined_order_id}&amount=${amount}&user_id=${AppConfig.user_id}");
  ...
  Future<SslcommerzBeginResponse> getSslcommerzBeginResponse(
      ...
      @required double amount) async {
    Uri url = Uri.parse(
        "${AppConfig.BASE_URL}/sslcommerz/begin?payment_type=${payment_type}&combined_order_id=${combined_order_id}&amount=${amount}&user_id=${AppConfig.user_id}");
  ...
  Future<NagadBeginResponse> getNagadBeginResponse(
      ...
      @required double amount) async {
    Uri url = Uri.parse(
        "${AppConfig.BASE_URL}/nagad/begin?payment_type=${payment_type}&combined_order_id=${combined_order_id}&amount=${amount}&user_id=${AppConfig.user_id}");
