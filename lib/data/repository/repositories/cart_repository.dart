...
import 'package:sokosellers/data/data_model/cart_count_response.dart';
import 'package:http/http.dart' as http;
import 'package:flutter/foundation.dart';
import 'dart:convert';
import 'package:sokosellers/data/data_model/cart_response.dart';
import 'package:sokosellers/data/data_model/cart_delete_response.dart';
import 'package:sokosellers/data/data_model/cart_process_response.dart';
import 'package:sokosellers/data/data_model/cart_add_response.dart';
import 'package:sokosellers/data/data_model/cart_summary_response.dart';
...
class CartRepository {
  ...
  Future<CartSummaryResponse> getCartSummaryResponse() async {
    ...
    print("access token ${AppConfig.bToken}");
